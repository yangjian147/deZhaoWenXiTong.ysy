...
public class PhoneCode {
	...
	public static void main(String[] args) {
		String phone = "16620844413"; // 此处可输入你的手机号码进行测试
		Map<String,Object> map=new HashMap<String,Object>();
		getPhonemsg(phone,map);
	 ...
	 * @return
	 */
	public static String getPhonemsg(String mobile,Map<String,Object> map) {
		...
		try {
			...
			if (sendSmsResponse.getCode() != null && sendSmsResponse.getCode().equals("OK")) {
				...
				map.put("yanzhengma",code);
				map.put("phone",mobile);
				map.put("pan","200");
			} else {
				// 如果验证码出错,会输出错误告诉你具体原因
